...
const AddFloorModal: React.FC<AddFloorModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-gray-900/50 p-4 backdrop-blur-sm">
      <div className="relative my-8 flex w-full max-w-md flex-col overflow-hidden rounded-xl bg-white shadow-xl">
        {/* Header */}
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm transition-shadow focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <div className="group relative mt-1 flex cursor-pointer justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6 transition-colors hover:border-blue-500 hover:bg-blue-50">
                <input
                  id="map-upload"
                  name="map-upload"
                  type="file"
                ...
                <div className="pointer-events-none space-y-2 text-center">
                  ...
                  <div className="flex justify-center text-sm text-gray-600">
                    <span className="relative font-medium text-blue-600 focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2 focus-within:outline-none">
        ...
        <div className="flex shrink-0 justify-end gap-3 border-t border-gray-200 bg-gray-50 px-6 py-4">
          ...
          <button
            ...
            className="flex min-w-[100px] items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:bg-blue-400"
          >
            {mutation.isPending ? (
